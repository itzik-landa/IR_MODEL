...
AreaCoverage_PB1 = 0;
AreaCoverage_PB2 = 100;
AreaCoverage_PB3 = 0;
AreaCoverage_PB4 = 0;%100;%[0 100]
AreaCoverage_PB5 = 50;%[50 50]
AreaCoverage_PB6 = 0;%50;%[100 100]
AreaCoverage_PB7 = 0;%

TotalCoverage = AreaCoverage_PB1+AreaCoverage_PB2+AreaCoverage_PB3+AreaCoverage_PB4+...
    AreaCoverage_PB5+AreaCoverage_PB6+AreaCoverage_PB7;
...
PB1_Start = (0.375*0+0.2+0.175/2)/Length;
PB2_Start = (0.375*1+0.2+0.175/2)/Length;
PB3_Start = (0.375*2+0.2+0.175/2)/Length;
PB4_Start = (0.375*3+0.2+0.175/2)/Length;
PB5_Start = (0.375*4+0.2+0.175/2)/Length;
PB6_Start = (0.375*5+0.2+0.175/2)/Length;
PB7_Start = (0.375*6+0.2+0.175/2)/Length;
...
T_IPU_1 = T_IPU_All;%90;%300;%
T_IPU_2 = T_IPU_All;%90;%300;%2150;%1200;%
T_IPU_3 = T_IPU_All;%90;%300;%
T_IPU_4 = T_IPU_All;%90;%300;%
T_IPU_5 = T_IPU_All;%90;%300;%
T_IPU_6 = T_IPU_All;%90;%300;%
T_IPU_7 = T_IPU_All;%90;%300;%

h_IPU = 200;

AirIPU_1_Start = 0.375*0/Length;
AirIPU_1_end = (0.375*0+0.2)/Length;
AirIPU_2_Start = 0.375*1/Length;
AirIPU_2_end = (0.375*1+0.2)/Length;
AirIPU_3_Start = 0.375*2/Length;
AirIPU_3_end = (0.375*2+0.2)/Length;
AirIPU_4_Start = 0.375*3/Length;
AirIPU_4_end = (0.375*3+0.2)/Length;
AirIPU_5_Start = 0.375*4/Length;
AirIPU_5_end = (0.375*4+0.2)/Length;
AirIPU_6_Start = 0.375*5/Length;
AirIPU_6_end = (0.375*5+0.2)/Length;
AirIPU_7_Start = 0.375*6/Length;
AirIPU_7_end = (0.375*6+0.2)/Length;
...
W_SolidsPB1 = W_Solids_100*(AreaCoverage_PB1/100);
W_PGPB1 = W_PG_100*(AreaCoverage_PB1/100);
W_WaterPB1 = W_Water_100*(AreaCoverage_PB1/100);
W_SolidsPB2 = W_Solids_100*(AreaCoverage_PB2/100);
W_PGPB2 = W_PG_100*(AreaCoverage_PB2/100);
W_WaterPB2 = W_Water_100*(AreaCoverage_PB2/100);
W_SolidsPB3 = W_Solids_100*(AreaCoverage_PB3/100);
W_PGPB3 = W_PG_100*(AreaCoverage_PB3/100);
W_WaterPB3 = W_Water_100*(AreaCoverage_PB3/100);
W_SolidsPB4 = W_Solids_100*(AreaCoverage_PB4/100);
W_PGPB4 = W_PG_100*(AreaCoverage_PB4/100);
W_WaterPB4 = W_Water_100*(AreaCoverage_PB4/100);
W_SolidsPB5 = W_Solids_100*(AreaCoverage_PB5/100);
W_PGPB5 = W_PG_100*(AreaCoverage_PB5/100);
W_WaterPB5 = W_Water_100*(AreaCoverage_PB5/100);
W_SolidsPB6 = W_Solids_100*(AreaCoverage_PB6/100);
W_PGPB6 = W_PG_100*(AreaCoverage_PB6/100);
W_WaterPB6 = W_Water_100*(AreaCoverage_PB6/100);
W_SolidsPB7 = W_Solids_100*(AreaCoverage_PB7/100);
W_PGPB7 = W_PG_100*(AreaCoverage_PB7/100);
W_WaterPB7 = W_Water_100*(AreaCoverage_PB7/100);
...
z_Wet_Initial = ...
    W_PG(1)+W_Water(1)+W_PGPB1+W_WaterPB1+W_PGPB2+W_WaterPB2+W_PGPB3+W_WaterPB3+W_PGPB4+W_WaterPB4...
    +W_PGPB5+W_WaterPB5+W_PGPB6+W_WaterPB6+W_PGPB7+W_WaterPB7;
...
while timePass(i-1)<=time
    ...
    if timePass(i-1)>=PB1_Start*time && PB1_Ready && AreaCoverage_PB1>0
        if ~DemiLayer
        ...
        PB1_Ready = false;
    elseif timePass(i-1)>=PB2_Start*time && PB2_Ready && AreaCoverage_PB2>0
        if ~DemiLayer
        dz_Ink = (W_Solids(i-1)+W_PG(i-1)+W_Water(i-1));
        T_Ink(i-1) = (T_Ink(i-1)*(ro_Solids*Cp_Solids*W_Solids(i-1)+ro_PG*Cp_PG*W_PG(i-1)+ro_Water*Cp_Water*W_Water(i-1))+...
        ...
        W_Solids(i-1) = W_Solids(i-1) + W_SolidsPB2;
        ...
        PB2_Ready = false;
    elseif timePass(i-1)>=PB3_Start*time && PB3_Ready && AreaCoverage_PB3>0
        if ~DemiLayer
        dz_Ink = (W_Solids(i-1)+W_PG(i-1)+W_Water(i-1));
        T_Ink(i-1) = (T_Ink(i-1)*(ro_Solids*Cp_Solids*W_Solids(i-1)+ro_PG*Cp_PG*W_PG(i-1)+ro_Water*Cp_Water*W_Water(i-1))+...
        ...
        PB3_Ready = false;
    elseif timePass(i-1)>=PB4_Start*time && PB4_Ready && AreaCoverage_PB4>0
        if ~DemiLayer
        dz_Ink = (W_Solids(i-1)+W_PG(i-1)+W_Water(i-1));
        T_Ink(i-1) = (T_Ink(i-1)*(ro_Solids*Cp_Solids*W_Solids(i-1)+ro_PG*Cp_PG*W_PG(i-1)+ro_Water*Cp_Water*W_Water(i-1))+...
        ...
        PB4_Ready = false;
    elseif timePass(i-1)>=PB5_Start*time && PB5_Ready && AreaCoverage_PB5>0
        if ~DemiLayer
        dz_Ink = (W_Solids(i-1)+W_PG(i-1)+W_Water(i-1));
        T_Ink(i-1) = (T_Ink(i-1)*(ro_Solids*Cp_Solids*W_Solids(i-1)+ro_PG*Cp_PG*W_PG(i-1)+ro_Water*Cp_Water*W_Water(i-1))+...
                      T_InkPB5*(ro_Solids*Cp_Solids*W_SolidsPB5+ro_PG*Cp_PG*W_PGPB5+ro_Water*Cp_Water*W_WaterPB5))/...
                     (ro_Solids*Cp_Solids*W_Solids(i-1)+ro_PG*Cp_PG*W_PG(i-1)+ro_Water*Cp_Water*W_Water(i-1)+...
                      ro_Solids*Cp_Solids*W_SolidsPB5+ro_PG*Cp_PG*W_PGPB5+ro_Water*Cp_Water*W_WaterPB5);
        ...
        PB5_Ready = false;
    elseif timePass(i-1)>=PB6_Start*time && PB6_Ready && AreaCoverage_PB6>0
        if ~DemiLayer
        dz_Ink = (W_Solids(i-1)+W_PG(i-1)+W_Water(i-1));
        T_Ink(i-1) = (T_Ink(i-1)*(ro_Solids*Cp_Solids*W_Solids(i-1)+ro_PG*Cp_PG*W_PG(i-1)+ro_Water*Cp_Water*W_Water(i-1))+...
        ...
        PB6_Ready = false;
    elseif timePass(i-1)>=PB7_Start*time && PB7_Ready && AreaCoverage_PB7>0
        if ~DemiLayer
        dz_Ink = (W_Solids(i-1)+W_PG(i-1)+W_Water(i-1));
        T_Ink(i-1) = (T_Ink(i-1)*(ro_Solids*Cp_Solids*W_Solids(i-1)+ro_PG*Cp_PG*W_PG(i-1)+ro_Water*Cp_Water*W_Water(i-1))+...
...
%         T_Ink(i) = T_Ink(i) + (Q_radiation_Ink)/(Length_IR_Dryer*Width)*dt/(ro_Ink.*Cp_Ink.*dz_Ink);
        ...
        IRDryerON = true;
    elseif timePass(i)>=(AirIPU_1_Start*time) && timePass(i)<(AirIPU_1_end*time)
        ih_up = 1/h_IPU;
        T_air_Hot = T_IPU_1;
    elseif timePass(i)>=(AirIPU_2_Start*time) && timePass(i)<(AirIPU_2_end*time)
        ih_up = 1/h_IPU;
        T_air_Hot = T_IPU_2;
    elseif timePass(i)>=(AirIPU_3_Start*time) && timePass(i)<(AirIPU_3_end*time)
        ih_up = 1/h_IPU;
        T_air_Hot = T_IPU_3;
    elseif timePass(i)>=(AirIPU_4_Start*time) && timePass(i)<(AirIPU_4_end*time)
        ih_up = 1/h_IPU;
        T_air_Hot = T_IPU_4;
    elseif timePass(i)>=(AirIPU_5_Start*time) && timePass(i)<(AirIPU_5_end*time)
        ih_up = 1/h_IPU;
        T_air_Hot = T_IPU_5;
    elseif timePass(i)>=(AirIPU_6_Start*time) && timePass(i)<(AirIPU_6_end*time)
        ih_up = 1/h_IPU;
        T_air_Hot = T_IPU_6;
    elseif timePass(i)>=(AirIPU_7_Start*time) && timePass(i)<(AirIPU_7_end*time)
        ih_up = 1/h_IPU;
        T_air_Hot = T_IPU_7;
...
z_Water_Initial = ...
    W_Water(1)+W_WaterPB1+W_WaterPB2+W_WaterPB3+W_WaterPB4...
    +W_WaterPB5+W_WaterPB6+W_WaterPB7;

z_PG_Initial = ...
    W_PG(1)+W_PGPB1+W_PGPB2+W_PGPB3+W_PGPB4...
    +W_PGPB5+W_PGPB6+W_PGPB7;
